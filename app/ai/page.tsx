...
const AiChat = () => {
  return (
    <main className="min-h-screen bg-white">
        ...
        />
      <div className="relative min-h-screen max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 flex flex-col">
        ...
        >
          <Link
            href="/"
            className="group inline-flex items-center px-3 sm:px-4 py-2 bg-white/20 backdrop-blur-md rounded-full border border-white/30 shadow-lg text-sm font-medium text-gray-800 hover:bg-white hover:border-gray-200 transition-all duration-300"
          >
