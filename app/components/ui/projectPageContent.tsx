...
import { ArrowLeftIcon, UserIcon, CalendarDaysIcon, CheckCircleIcon, WrenchScrewdriverIcon, HomeIcon } from "@heroicons/react/24/solid";
        ...
        >
          ...
          >
            <div className="flex items-center gap-0 group-hover:gap-2 transition-all duration-300">
              ...
              <span className="flex gap-1 items-center font-mono text-xs font-medium text-gray-600"><HomeIcon className="h-3 w-3 flex-shrink-0" />Home</span>
            </div>
          </Link>
        </motion.div>
          ...
          <div className="flex flex-col items-center gap-2 pb-16">
            ...
            >
              <div className="flex items-center gap-2">
                <UserIcon className="w-4 h-4" style={{ color: project.primaryColor }} />
                <span className="font-mono font-medium text-gray-600">{project.role}</span>
              </div>
              
              <div className="flex items-center gap-2">
                <CalendarDaysIcon className="w-4 h-4" style={{ color: project.primaryColor }} />
                <span className="font-mono font-medium text-gray-600">{project.startDate}</span>
              </div>
              
              <div className="flex items-center gap-2">
                <CheckCircleIcon className="w-4 h-4" style={{ color: project.primaryColor }} />
                <span className="font-mono font-medium text-gray-600">{project.completedDate}</span>
              </div>
              
              <div className="flex items-center gap-2">
                <WrenchScrewdriverIcon className="w-4 h-4" style={{ color: project.primaryColor }} />
                <span className="font-mono font-medium text-gray-600">{project.tools.join(", ")}</span>
              </div>
            </motion.div>
          </div>
